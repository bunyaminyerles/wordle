...
function encodeTurkishCharacters(text: string) {
  return encodeURIComponent(text);
}

function decodeTurkishCharacters(encodedText: string) {
...
export const action: ActionFunction = async ({request}) => {
  ...
  const result =
      checkGuess(guess, session.get("word"));
  console.log(guess, session.get("word"));
